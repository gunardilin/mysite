...
{{< /rawhtml >}}
aims to help calculating the fair value of a company stock. It calculate if a stock is **over**- or **under**valued, based on  its last available annual earning and current interest rate. Without this web app, the author would have to scour the internet to copy the financial datas and entering them manualy into calculator to get an estimation.
